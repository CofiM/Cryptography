...
namespace ZI_Projekat
{
    class Bifid 
    {
        ...
        public List<string> Encrypt(string filePath, string textForCoding)
        {
            ...
            //{
                string temp;
                oneLine += textForCoding.Replace(" ", "") + "\n";
                this.stepOneEncrypt(textForCoding.ToLower(), out rcValues);
        ...
        public List<string> Decrypt(string filePath, out bool sameHashes, List<string> plaintextLines)
        {
            sameHashes = false;

            string[] splited = filePath.Split('\\');
            string fileName = splited[splited.Length - 1].Replace("Encrypted.txt", "testKeySquare.txt");
            this.LoadKey(fileName);
        ...
        public void LoadKey(string fileName)
        {
            ...
            string filePath = "Key Squares\\testKeySquare.txt";// + fileName;
